            ...
            <div class="w3-container w3-card-4 w3-white w3-padding-0 w3-margin">
                ...
                <div class="w3-container w3-padding">
                    ...
                    <form class="w3-form" id="movieSearch">
                        <div class="w3-row">
                        <?php echo '<input class="w3-col s10 m10 l10 w3-input w3-btn w3-light-grey" type="text" placeholder="Search Movie Titles..." name="find" id="find" onkeyup="showResults(this.value, '.$_SESSION['user_id'].', 0)"/>'; ?>
